...
// Descargar permiso del personal 
const downloadPlanillaVacacion = () => {
    return api.get(`/planillavacaciones`, {
        responseType: 'blob', // Necesario para manejar la descarga del archivo como un blob
    });
};
...
const downloadReportePersonal = () => {
    return api.get('/exportar-personas', {
    responseType: 'blob', // para que se descargue como archivo
    });
    };
const downloadReportePlanillaExcel = () => {
    return api.get('/planillavacacionesexcel', {
    responseType: 'blob', // para que se descargue como archivo
    });
};
...
export default { 
    ...
    downloadPlanillaVacacion,
    downloadReportePersonal,
    downloadReportePlanillaExcel
};
