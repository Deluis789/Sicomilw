...
export function Personalrrhh() {
  ...
  const pages = Math.ceil(usersAct.length / rowsPerPage);
  ...
  }, [usersAct, filterValue, statusFilter]);
  ...
  const { descargarExcelPersonal } = usePartes(); // LLamado a la función PartesContext
    ...
    return (
      <div className="flex flex-col gap-4">
        <div className="flex justify-between gap-3 items-end">
          ...
          <Button
            onClick={descargarExcelPersonal}
            endContent={<FileText className="text-small" />}
            size="sm"
            variant="flat"
            className="bg-green-600 hover:bg-green-700 text-white border border-green-600 shadow-sm transition-colors duration-200"
          >
